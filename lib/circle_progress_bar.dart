...
class CircleProgressBarState extends State<CircleProgressBar>
  ...
  void didUpdateWidget(CircleProgressBar oldWidget) {
    ...
    //TODO: make a (serious) case for level up: need tween animation from current value to 1.0, and from 0.0 to new value (listener implementation?)
    if (this.widget.value > oldWidget.value) {
      ...
      this._controller
        ..value = 0
        ..forward();
    } else if (this.widget.value < oldWidget.value){
...
class CircleProgressBarPainter extends CustomPainter {
  ...
  CircleProgressBarPainter({
    ...
    double strokeWidth,
  }) : this.strokeWidth = strokeWidth ?? 3.5;
